...
import { translateYY50, opacity1, translateXX } from '../../animations';

export const HomeApp = (): JSX.Element => {
  const [element, controls] = useScroll();
  return (
    <div ref={element} style={{ paddingBottom: 30 }}>
          ...
          <Box className="container-text">
            ...
            >
              ...
              <Typography variant="body1" className="body">
                ...
                Nesciunt sed placeat, incidunt aliquam sapiente reprehenderit
                iste velit in blanditiis corrupti.
              </Typography>
            </motion.div>
          </Box>
          <motion.div
